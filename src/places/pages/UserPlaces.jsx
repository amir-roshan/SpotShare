...
const UserPlaces = () => {
    const DUMMY_PLACES = [
        {
            id: 'p1',
            image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFg9lIo9D1LEh4_4p0V9LvFk2LKj4WvjqsYw&s",
        ...
        {
            id: 'p3',
            imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFg9lIo9D1LEh4_4p0V9LvFk2LKj4WvjqsYw&s",
            title: "City Park",
    ...
    const loadedPlaces = DUMMY_PLACES.filter(place => place.creatorId === parseInt(userId));
